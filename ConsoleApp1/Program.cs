...
{
    Console.WriteLine($"One of my favorite movies{movie.title} was released in {movie.year} the movies rating was {movie.rating}");
}

static string[] GetDataFromFIle()
{
    string filePath = @"C:\Users\alina\Downloads\Movies.txt";
